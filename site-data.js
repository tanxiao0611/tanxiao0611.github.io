window.siteData = {
  ...
  books: {
    title: "Books",
    intro:
      "A selected list of books I’ve read, organized by year. Last updated in May 2026. Click on any title to read a naive review (if exists) written by my 16-year-old self. ",
    entries: [
      {
